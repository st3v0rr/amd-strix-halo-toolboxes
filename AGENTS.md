...
*   `/toolboxes/`: Dockerfiles used to build the container images (e.g., `rocm-10.0`, `vulkan-radv`). These often use multi-stage builds to compile Llama.cpp and extract standalone binaries.
